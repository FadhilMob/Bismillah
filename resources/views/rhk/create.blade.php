                                    ...
                                    <tr>
                                        <table class="table table-bordered" id="table">
                                            {{-- Data RHK--}}
                                                <div class="form-row">
                                                    <div class="form-group col-md-3">
                                                        <td>
                                                            <label for="exampleInputEmail1">Data RHK</label>
                                            ...
                                            {{-- Intervensi --}}
                                                    <div class="form-group col-md-3">
                                                        <td>
                                                            <label for="exampleInputEmail1" class="form-label mt-10">Kode Intervensi</label>
                                                                <div class="dropdown">
                                                                    <div class="btn-group">
                                                                        <select id="intervensi-dropdown" class="form-control" name="intervensi_id[]">
                                                                            <option value="">-- Pilih Kode Intervensi --</option>
