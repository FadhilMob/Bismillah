...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('dashboard', function (Blueprint $table) {
            ...
            $table->bigInteger('bidang_id')->nullable()->unsigned();
            $table->bigInteger('intervensi_id')->nullable()->unsigned();
            $table->bigInteger('rhk_id')->nullable()->unsigned();
            $table->bigInteger('laporan_id')->nullable()->unsigned();
            $table->timestamps();
